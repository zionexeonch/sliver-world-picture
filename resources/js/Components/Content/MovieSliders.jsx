...
const isSliderMovie = (slidermovies) => {
    return slidermovies.slice(0, 8).map((slidermovie, i) => {
        return (
            <div key={i} className="snap-start snap-always shrink-0">
                <Link href={`/details/movies/${slidermovie.judul}`}>
                        ...
                        <div className="relative">
                            ...
                            <div className="w-full flex flex-wrap content-center">
                                <img
                                    ...
                                    src={slidermovie.url_image}
                                    alt={slidermovie.judul}
                                />
...
const MovieSliders = ({ slidermovies }) => {
    return !slidermovies ? noSliderMovie() : isSliderMovie(slidermovies);
};
